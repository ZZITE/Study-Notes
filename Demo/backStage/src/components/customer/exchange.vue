    ...
    <div class="huanmeng-header">
      ...
      <div class="ation-nav">
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="所有换货" name="first">
            <div class="class-z">
          ...
          <el-tab-pane label="已配送" name="fourth">4</el-tab-pane>
          <el-tab-pane label="完成换货" name="five">5</el-tab-pane>
          <el-tab-pane label="拒绝换货" name="six">6</el-tab-pane>
        </el-tabs>
      </div>
    </div>
...
.huanmeng-header button:hover {
  color: #E54C87;
}
.huanmeng .el-tabs__item.is-active {
  color: #E54C87;
}
.huanmeng-header .el-input__icon+.el-input__inner {
  width: 330px;
  height: 32px;
  border-radius: 0;
}
.huanmeng-header .el-input__icon {
  right: 20px;
}
.huanmeng-header .el-input {
  width: 330px;
  height: 32px;
  margin-left: 20px;
}
.huanmeng-header button {
    font-size: 14px;
    border: 0;
    outline: 0;
    color: #747474;
...
.huanmeng-header .ation-nav {
  width: 100%;
  height: 52px;
} 
.huanmeng-header .el-tabs__item:hover {
  text-decoration: underline;
}
.huanmeng-header .el-tabs__item.is-active {
  color: #E54C87;
}
.huanmeng-header .el-tabs__item {
  font-size: 16px;
}
.huanmeng-header .el-tabs__active-bar {
  height: 0;
}
.huanmeng-header .el-tabs__nav-scroll {
  margin-top: 10px;
}
.class-z {
  width: 100%;
